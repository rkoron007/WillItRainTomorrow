...
var _weather_form = __webpack_require__(26);

var _weather_form2 = _interopRequireDefault(_weather_form);

var _weather_show = __webpack_require__(32);

var _weather_show2 = _interopRequireDefault(_weather_show);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var App = function App() {
    return _react2.default.createElement(_weather_form2.default, null);
};
...
var _weather_util = __webpack_require__(27);
...
var WeatherForm = function (_Component) {
  ...
  _createClass(WeatherForm, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var currentPlace = (0, _weather_util.fetchLocation)(this.state.location);
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'weather-form-box' },
        _react2.default.createElement(
          'form',
          { className: 'weather-form', onSubmit: this.handleSubmit },
          _react2.default.createElement(
            'h1',
            { className: 'location-input-header' },
            'Going Somewhere Else?'
          ),
          _react2.default.createElement(
            'h2',
            null,
            'Let\'s check if it\'ll rain there too:'
          ),
...
var fetchLocation = exports.fetchLocation = function fetchLocation(data, callback) {
